            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbar-menu">
                    <ul class="nav navbar-nav ml-auto" data-in="fadeInDown" data-out="fadeOutUp">
                        <li class="nav-item active"><a class="nav-link" href="index.html">Cachimbas</a></li>
                        <li class="nav-item"><a class="nav-link" href="about.html">Cazoletas</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.html">Mangueras</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.html">Bases</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.html">Accesorios</a></li>
<?php
    ...
    if (isset($_SESSION['usuario'])) {
        ...
        echo '  
                <button type="button" class="btn btn-outline-danger ml-auto">Registrarse</button>
                <button type="button" class="btn btn-warning">loguearse</button>';
            
    }
?>
                        <!--<li class="dropdown megamenu-fw">
                            <a href="#" class="nav-link dropdown-toggle arrow" data-toggle="dropdown">Todas las categorias</a>
    ...
    <div class="container">
        <h1 class="text-center mt-5 ">Compra y vende cosas que no utilices</h1>
        <h2 class="text-center mb-5 mt-3">Da una segunda oportunidad</h2>
